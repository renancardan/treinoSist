...
const App = ({setVerMoldEditEmp, VerMoldEditEmp, IdEmp,  setNome, Nome, setNomeEmp, NomeEmp, Email, setEmail, Rua, setRua, setNumero, Numero, setBairro, Bairro, Complemento, setComplemento, Cidade, setCidade, Estado, setEstado, ValorMen, setValorMen, ValorApp, setValorApp, DiaMes, setDiaMes, Coment, setComent, Img, setImg, Ativo, setAtivo }) => {
  ...
  const AddicionadoEmp = ()=>{
    ...
    if(Nome ){
      if(NomeEmp ){
        setCarreg(true)
        Api.EmppEdit(IdEmp, Nome, NomeEmp, Email, Tel, Rua, Numero, Bairro, Complemento, Cidade, Estado, Coment, ValorMen, ValorApp, DiaMes, Img, IrImg, Ativo, setMsgErro1, setCarreg, setMsgSucesso)
  ...
  return (
      ...
      <Modal
        transparent={true}
        visible={VerMoldEditEmp}
        animationType="slide"
        onRequestClose={() =>setVerMoldEditEmp(false)}
      >
        <View style={styles.overlay} >
          ...
          <Text style={styles.menuItem}>Editar Empresa</Text>
          <View >
            <></>
             </View>
             </>
  ...
  <Text style={{fontSize:10, color:"red" }}>{MsgErro1}</Text>
          ...
          <Text style={{fontSize:17}}>Conta Empresa:</Text>
          {Ativo ?
          <TouchableHighlight onPress={()=>setAtivo(false)} style={styles.Ativador}> 
          <>
          ...
          :
          <TouchableHighlight onPress={()=>setAtivo(true)} style={styles.DesAtivador}> 
          <>
