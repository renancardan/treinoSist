...
const App = ({setVerMoldEditEmp, VerMoldEditEmp, IdEmp,  setNome, Nome, setNomeEmp, NomeEmp, Email, setEmail, Rua, setRua, setNumero, Numero, setBairro, Bairro, Complemento, setComplemento, Cidade, setCidade, Estado, setEstado, ValorMen, setValorMen, ValorApp, setValorApp, DiaMes, setDiaMes, Coment, setComent, Img, setImg }) => {
  ...
  const AddicionadoEmp = ()=>{
    ...
    if(Nome ){
      if(NomeEmp ){
        setCarreg(true)
        Api.EmppEdit(IdEmp, Nome, NomeEmp, Email, Tel, Rua, Numero, Bairro, Complemento, Cidade, Estado, Coment, ValorMen, ValorApp, DiaMes, Img, IrImg, setMsgErro1, setCarreg, setMsgSucesso)
      ...
      >
        <View style={styles.overlay} >
          ...
          style={styles.Container2}>
             <TouchableHighlight  onPress={() => setVerMoldEditEmp(false)}style={styles.Container7}>
            <>
          <View >
