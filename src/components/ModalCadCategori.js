...
const App = ({setVerMoldCadCategori, VerMoldCadCategori, }) => {
    ...
    const [PorCentPg, setPorCentPg] = useState("");
  ...
  const AddicionadoRep = ()=>{
    ...
    if(Nome ){
        ...
        setCarreg(true)
        Api.RepAdd(Nome, Tel, Coment, DiaMes, PorCentPg, setMsgErro1, setCarreg, setMsgSucesso)
  ...
  return (
      ...
      >
        <View style={styles.overlay} >
          ...
          <Text style={styles.menuItem}>Cadastrar Categoria</Text>
          <View >
            <></>
             </View>
             </>
  ...
  <InputNome
         ...
         <Text style={{fontSize:17}}>% do Pag.:</Text>
           <InputDia
                       ...
                       placeholder="Digite a % do Papamento" 
                       value={PorCentPg}
